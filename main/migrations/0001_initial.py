    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ManyToManyField(blank=True, null=True, to='main.order', verbose_name='Заказ')),
                ('sale', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.sale', verbose_name='Товар на акции')),
            ],
            options={
