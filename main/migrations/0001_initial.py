    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('countitemproduct', models.ManyToManyField(blank=True, null=True, to='main.countitemproduct', verbose_name='Количество товара')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('street', models.CharField(blank=True, max_length=40, null=True, verbose_name='Улица')),
