...
for (let i of wishList) {
  ...
  li.innerHTML = `
    ...
    <a href="${i.link}" class="products___item-title">
        ${i.title}
    </a>
    <ul class="slider__item-weight-list">
    ${i.weight.map(weight => `<li class="slider__item-weight-list-item" data-weight-id="${i.id}">${weight}</li>`).join('')}
    </ul>
    <div class="products___item-price-basket">
        <div class="products___item-price-basket-wrap">
        ${i.price.new ? `<div class="products___item-price-wrap">
        <p class="products___item-price-promotion">
            ${i.price.old}
        </p>
        <div class="products___item-price-currency-wrap">
            <p class="products___item-price">${i.price.new}</p>
    ...
    <p class="products___item-price">${i.price.old}</p>
