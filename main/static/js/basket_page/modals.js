...
const weightButton = document.querySelectorAll('.basket__list-item-weight-text')
const youWeight = document.querySelectorAll('.basket__list-item-weight')
...
weightButton.forEach(item => {
    item.addEventListener('click', (e) => {
        if(e.currentTarget.parentElement.children[1].style.display !== 'flex') {
            console.log(111);
