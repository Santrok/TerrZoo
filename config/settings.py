...
# Configuration for DebugToolbar
INTERNAL_IPS = [
    "127.0.0.1",
]
...
SOCIALACCOUNT_PROVIDERS = {
    'google': {
        ...
        'APP': {
            'client_id': env_keys.get("SOCIAL_AUTH_GOOGLE_OAUTH2_CLIENT_ID"),
            'secret': env_keys.get("SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET"),
            'key': ''
        }
    }
}
...
SHORT_SESSION_SECONDS = 10800  # срок действия сессии, если не стоит птичка 'Запомнить меня'
